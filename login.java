...
public class login extends HttpServlet
{
	public void service(HttpServletRequest req , HttpServletResponse res)throws IOException , ServletException
	{
		...
		try{
			...
			if(type.equals("User")){
			    ResultSet rs=s.executeQuery("select firstname,pass from signup");
			        ...
			        while(rs.next()){
					    ...
					    RequestDispatcher dispatcher=req.getRequestDispatcher("alogin.html");
				...
				if(flag==0){
					...
					dispatcher.include(req,res);
				        ...
				        if(user.equals("admin")&& password.equals("admin")){
					     out.println("welcome " +user);
					     RequestDispatcher dispatcher1=req.getRequestDispatcher("alogin.html");
